...
public class GameVisualSimulationTest {
    public static void main(String args[]) throws Exception {
        ...
        AI ai1 = new StrategyChooser(1000, pf, new newAI(utt,pf), new WorkerRush(utt,pf), new LightRush(utt,pf), new HeavyRush(utt,pf), new RangedRush(utt,pf), new mattRushAi(utt), inertiaCycles);
