...
public class RunTournament {
    public static void main(String args[]) throws Exception {
        ...
        AIs.add( new RandomBiasedAI());
        AIs.add(new StrategyChooser(AITimeBudget, pf, new newAI(utt,pf), new WorkerRush2(utt,pf), new LightRush(utt,pf), new HeavyRush(utt,pf), new RangedRush(utt,pf), new mattRushAi(utt), inertiaCycles));
