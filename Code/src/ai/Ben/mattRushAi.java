 ...
 * @author santi
 */
public class mattRushAi extends AbstractionLayerAI {
    ...
    public mattRushAi(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }


    public mattRushAi(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
